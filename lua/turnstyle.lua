...
local function set_highlights()
	...
	local default_highlights = {
		...
		Cursor = { fg = palette.text, bg = palette.light_design_high },
		...
		Directory = { fg = palette.sunshower, bold = styles.bold },
		-- EndOfBuffer = {},
		ErrorMsg = { fg = groups.error, bold = styles.bold },
		FloatBorder = make_border(),
		FloatTitle = { fg = palette.sunshower, bg = groups.panel, bold = styles.bold },
		...
		Title = { fg = palette.sunshower, bold = styles.bold },
		...
		SnacksIndentScope = { fg = palette.sunshower },
